        ...
        <div class="relative pl-12 py-8 rounded-3xl bg-stone-200/50 dark:bg-slate-800/50" data-aos="fade-up">
            <div class="flex flew-row">
                <div class="basis-7/10">
                    ...
                    <div class="flex flex-row justify-left gap-4">
                        ...
                        <a href={props.institution_url.clone()} target="_blank" rel="noopener noreferrer" class="py-2 group flex items-center justify-left">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" class="h-10 w-10 mr-2 fill-slate-600 group-hover:fill-slate-700 dark:fill-slate-600 dark:group-hover:fill-slate-300 transition">
                            ...
                            <div class="text-xl/9 group-hover:font-bold text-slate-600 group-hover:text-slate-600 dark:text-slate-400 dark:group-hover:text-slate-300 transition"> {props.institution.clone()} </div>
                        </a>

                        // Location
                        <div class="py-2 flex items-center justify-left">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" class="h-10 w-10 mr-2 fill-slate-600 dark:fill-slate-600">
                        ...
                        // Time
                        <div class="py-2 flex items-center justify-left">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="h-10 w-10 mr-2 fill-slate-600 dark:fill-slate-600">
                    ...
                    <div class="pt-1 pb-2 flex flex-wrap gap-2">
                        {for props.skills.iter().map(|skill| html! { <div class="px-3 py-1 rounded-full text-lg text-center font-medium text-slate-500 dark:text-slate-500 bg-stone-50/25 dark:bg-slate-700/25">{skill}</div> })}
                    </div>

                    // Linked projects
                    <div class="pl-2 pt-1 pb-2 flex flex-wrap gap-x-4 gap-y-2 items-center">
                            ...
                            html! {
                                <Link<Route> to={to_route}>
                                    <div class="flex items-center justify-center group">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="h-6 w-6 mr-2 fill-slate-500 dark:fill-slate-500 group-hover:fill-slate-600 group-hover:dark:fill-slate-400">
                                            <path d="M320 0c-17.7 0-32 14.3-32 32s14.3 32 32 32l82.7 0L201.4 265.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L448 109.3l0 82.7c0 17.7 14.3 32 32 32s32-14.3 32-32l0-160c0-17.7-14.3-32-32-32L320 0zM80 32C35.8 32 0 67.8 0 112L0 432c0 44.2 35.8 80 80 80l320 0c44.2 0 80-35.8 80-80l0-112c0-17.7-14.3-32-32-32s-32 14.3-32 32l0 112c0 8.8-7.2 16-16 16L80 448c-8.8 0-16-7.2-16-16l0-320c0-8.8 7.2-16 16-16l112 0c17.7 0 32-14.3 32-32s-14.3-32-32-32L80 32z"/>
                                        </svg>
                                        <div class="py-1 text-lg text-center font-medium text-slate-500 dark:text-slate-500 group-hover:font-bold group-hover:text-slate-600 group-hover:dark:text-slate-400 transition">
                                            {project}
                                        </div>
                                    </div>
                                </Link<Route>>
                ...
                <div class="basis-3/10">
                    // Image
                    <a href={props.institution_url.clone()} target="_blank" class="h-full w-full flex-1 flex justify-center items-center hover:scale-105 transition">
