...
fn app() -> Html {
    ...
    html! {
        ...
        pl-12 lg:pl-44 pr-20 w-full h-full">
            <h1 class="text-8xl manual_h1 mb-4">{"Max Mohr"}</h1>
            <div class="flex mb-4">
                <a href="https://www.linkedin.com/in/maxjmohr/" target="_blank" class="mr-4">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class="w-8 h-8 fill-gray-700 dark:fill-stone-300">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="w-8 h-8 fill-gray-700 dark:fill-stone-300">
                        <path d="M448 230.2V480H0V230.2H141.1V355.1H306.9V230.2zM306.9 32H141.1V156.9H306.9z"/>
                    </svg>
                </a>
            </div>
            <span class="type-aboutme manual_p"></span>
        </div>
        ...
        <div id="footer" class="pb-52 lg:pb-6 bg-stone-300 dark:bg-stone-600">
            ...
            <p class="antialiased text-md text-gray-700 dark:text-stone-300 text-center font-medium px-20">{"I constructed this website on the basis of the "}
                <a href="https://yew.rs" target="_blank" class="italic hover:font-bold">{"yew.rs"}</a>
                    {" framework. It is in constant development. For more technical insights feel free to access the "}
                        <a href="https://github.com/maxjmohr/personal_website" target="_blank" class="italic hover:font-bold">{"GitHub repository"}</a>
                            {"."}</p>
        </div>
        </>
    }
