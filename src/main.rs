...
fn app() -> Html {
    ...
    html! {
        ...
        <aside class="sidebar">
            <ul class="links">
            <li>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class="flex w-16 h-16 p-2 fill-gray-700 dark:fill-stone-400">
        ...
        pl-44 w-full h-full">
            ...
            <div class="flex mb-4">
                <a href="https://www.linkedin.com/in/maxjmohr/" target="_blank" class="mr-4">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class="w-8 h-8 fill-gray-700 dark:fill-stone-400">
                ...
                <a href="mailto:maxjmohr@gmail.com">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class="w-8 h-8 fill-gray-700 dark:fill-stone-400">
