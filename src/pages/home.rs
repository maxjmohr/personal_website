...
pub fn Home() -> Html {
    ...
    html! {
        ...
        // Main content
        // About me
        <div id="aboutme" class="relative z-20 h-screen mx-20 flex flex-col justify-center items-center" data-aos="zoom-in">
            <div class="-mt-40">
                <div class="scale-50 -m-80">
                    <pre class="text-base text-mono leading-relaxed tracking-[.32em] text-slate-600 dark:text-slate-400">{ascii_display}</pre>
                </div>
            </div>
            <h1 class="pt-8 text-9xl font-medium text-slate-700 dark:text-slate-100">{"Max Mohr"}</h1>
            <div class="h-10 pt-6 text-3xl text-center leading-normal text-slate-600 dark:text-slate-300">
                <span class="type-aboutme"></span>
            </div>
            <div class="absolute bottom-0 flex pb-10">
                <a href="https://www.linkedin.com/in/maxjmohr/" target="_blank" class="mr-6 lg:mr-4">
                    <svg xmlns="http://www.w3.org/2000/svg" width="36" height="24" viewBox="0 0 24 24" class="w-16 h-16 lg:w-8 lg:h-8 fill-current text-slate-700 dark:text-slate-400 dark:hover:text-slate-100">
                ...
                <a href="https://github.com/maxjmohr" target="_blank" class="mr-6 lg:mr-4">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class="w-16 h-16 lg:w-8 lg:h-8 fill-current text-slate-700 dark:text-slate-400 dark:hover:text-slate-100">
                ...
                <a href="https://unsplash.com/@maxjmohr" target="_blank" class="mr-6 lg:mr-4">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="w-16 h-16 lg:w-8 lg:h-8 fill-current text-slate-700 dark:text-slate-400 dark:hover:text-slate-100">
        ...
        // Two column layout
        <div class="relative z-20 h-screen grid grid-cols-1 md:grid-cols-[2fr_5fr]">
            <div class="relative z-20 h-screen mx-20 flex flex-col justify-center items-center" data-aos="fade-right">
                <div class="-mt-40">
                    <div class="scale-35 -m-80">
                        <pre class="text-base text-mono leading-relaxed tracking-[.32em] text-slate-600 dark:text-slate-400">{ascii_display}</pre>
                    </div>
                </div>
                <h1 class="pt-8 text-6xl font-medium text-slate-700 dark:text-slate-100">{"Max Mohr"}</h1>
                <div class="absolute bottom-0 flex pb-10">
                    <a href="https://www.linkedin.com/in/maxjmohr/" target="_blank" class="mr-6 lg:mr-4">
                        <svg xmlns="http://www.w3.org/2000/svg" width="36" height="24" viewBox="0 0 24 24" class="w-16 h-16 lg:w-8 lg:h-8 fill-current text-slate-700 dark:text-slate-400 dark:hover:text-slate-100">
                            <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
            ...
            <div class="flex items-center justify-center p-8" data-aos="fade-left">
                <div class="h-10 pt-6 text-3xl text-center leading-normal text-slate-600 dark:text-slate-300">
                    {"Hey, I'm Max. I am currently finishing my data science masters in Tübingen. I am working at BearingPoint focusing on data engineering, analysis and driving AI innovation."}
                </div>
            </div>
        </div>

        // Professional experience
        <div id="profexper" class="relative z-20 h-full flex flex-col justify-center pl-12 lg:pl-44 pr-20">
        ...
        // Education
        <div id="educ" class="relative z-20 h-full flex flex-col justify-center pl-12 lg:pl-44 pr-20">
            <h1 class="text-8xl lg:text-7xl manual_h1" data-aos="fade">{"Education"}</h1>
            { for content_educ_timeline.iter().cloned() }
        </div>

        // Projects
        <div id="projects" class="relative z-20 h-full flex flex-col justify-center pl-12 lg:pl-44 pr-20">
        ...
        // Languages
        <div id="langs" class="relative z-20 h-full flex flex-col justify-center pl-12 lg:pl-44 pr-20">
        ...
        // Footer
        <div id="footer" class="relative z-20 pb-52 lg:pb-6">
